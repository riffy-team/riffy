# Welcome to Riffy contributing guide <!-- omit in toc -->
...
Scan through our [Existing Isssues](https://github.com/riffy-team/riffy/issues) to find one that interests you. You can narrow down the search using `labels` as filters. As a general rule, we don’t assign issues to anyone. If you find an issue to work on, you are welcome to open a PR with a fix.
...
Once you submit your PR, our team members will review your proposal. We may ask questions or request additional information.
...
Congratulations :tada::tada: The Riffy team thanks you :sparkles:.
